...
public class PanelAutomaticImpl extends PanelAutomaticAbstract implements PanelAutomatic {	
	
	public PanelAutomaticImpl(ManagementAutomatic management, PanelMenuAutomaticAbstract panelMenu, Color background) {
		super(management, new ToolTipManagerAutomaticImpl());
		this.management = management;
		this.panelMenu = panelMenu;
		this.background = background;
		this.setBackground(background);
		this.tooltip = new ToolTipManagerAutomaticImpl();
		initComponents();
		initLayout();
		updateComponents();
	}
	...
	private PanelMenuAutomaticAbstract panelMenu;
