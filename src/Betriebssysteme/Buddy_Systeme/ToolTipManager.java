...
public class ToolTipManager {
	...
	public static String getToolTipSpaceSize() {
	...
	public static String getToolTipProcessName() {
	...
	public static String getToolTipProcessSize() {
	...
	public static String getToolTipLoadExample() {
