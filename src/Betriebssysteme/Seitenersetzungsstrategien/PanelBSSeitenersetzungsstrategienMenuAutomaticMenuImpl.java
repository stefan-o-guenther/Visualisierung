...
public class PanelBSSeitenersetzungsstrategienMenuAutomaticMenuImpl extends PanelMenuMenuButtonsAbstract {;
	
	public PanelBSSeitenersetzungsstrategienMenuAutomaticMenuImpl(ManagementPaging paging, ToolTipManagerPaging tooltip) {
		super(paging, tooltip);
	}
	
	private PanelBSSeitenersetzungsstrategienMenuAutomaticMenuImpl() {
