...
public class ReplacementStrategyOptimalImpl extends ReplacementStrategyAbstract implements ReplacementStrategyOptimal {
	
	public ReplacementStrategyOptimalImpl(List<Integer> sequence, Integer ram, Integer disk) {
