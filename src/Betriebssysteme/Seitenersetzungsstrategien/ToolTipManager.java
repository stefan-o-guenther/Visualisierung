...
public class ToolTipManager {
	...
	public static String getToolTipStrategy() {
		String tooltipStrategy = ""
			+ "<html>"
	    	+ "<strong>Optimale Strategie:</strong><br/>"
	    	+ "<p>"
	    	+ "Das beste w&auml;re, wenn die Seitenersetzung immer die zuk&uuml;nfigen<br/>"
	    	+ "Seitenzugriffe aller Prozesse ber&uuml;cksichtigen k&ouml;nnte, weil dann<br/>"
	    	+ "wenige Seitenfehler auftreten w&uuml;rden. Ein optimaler Algorithmus w&uuml;rde<br/>"
	    	+ "die Seitenrahmen f&uuml;r eine Ersetzung ausw&auml;hlen, die am sp&auml;testen von allen<br/>"
	    	+ "belegten Seitenrahmen wieder ben&ouml;tigt w&uuml;rden.<br/>"
	    	+ "</p>"
	    	+ "<br/>"
	...
	public static String getToolTipReference() {
	...
	public static String getToolTipRam() {
		String tooltipRam = ""
			+ "<html>"
		  	+ "Anzahl RAM-Seiten"
		  	+ "</html>";
	...
	public static String getToolTipDisk() {
		String tooltipDisk = ""
			+ "<html>"
		  	+ "Anzahl Disk-Seiten"
		  	+ "</html>";
	...
	public static String getToolTipPagingError() {
	...
	public static String getToolTipR() {
		String tooltipR = ""
			+ "<html>"
	...
	public static String getToolTipM() {
		String tooltipM = ""
			+ "<html>"
