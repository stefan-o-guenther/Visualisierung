...
public class PanelMenuControlSpeedImpl extends PanelMenuControlSliderAbstract {

	private static final long serialVersionUID = 1L;
	
	public PanelMenuControlSpeedImpl(ManagementPipelineProtocol pipeline) {
		super(pipeline);
	}
	
	private PanelMenuControlSpeedImpl() {
