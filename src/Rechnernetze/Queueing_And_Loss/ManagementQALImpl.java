...
public class ManagementQALImpl extends ManagementAbstract implements ManagementQAL {

    private static ManagementQAL instance = new ManagementQALImpl();
    
    private ManagementQALImpl() {
    	super();
    }
 
    public static ManagementQAL getInstance() {
    	return instance;
    }
