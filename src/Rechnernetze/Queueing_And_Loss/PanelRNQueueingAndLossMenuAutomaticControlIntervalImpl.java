...
public class PanelRNQueueingAndLossMenuAutomaticControlIntervalImpl extends PanelMenuControlSliderAbstract {

	public PanelRNQueueingAndLossMenuAutomaticControlIntervalImpl(Management management, ToolTipManager tooltip) {
		super(management, tooltip);
	}
	
	public PanelRNQueueingAndLossMenuAutomaticControlIntervalImpl() {
